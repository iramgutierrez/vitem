...
class UsersController extends \BaseController {
	...
	public function __construct()
	{
		...
		$this->beforeFilter('ACL:User,Read,No tienes permiso para ver usuarios.', ['only' => 'index' , 'show' ]);

		$this->beforeFilter('ACL:User,Create,No tienes permiso para agregar usuarios.', ['only' => 'create' , 'store' ]);

		$this->beforeFilter('ACL:User,Update,No tienes permiso para editar usuarios.', array('only' => 'edit' , 'update'));

		$this->beforeFilter('ACL:User,Delete,No tienes permiso para eliminar usuarios.', array('only' => 'destroy'));
	...
	public function show($id)
	{
		...
		return View::make('users/show', compact('roles' , 'employee_types' , 'user'));
	}
