...
<div ng-app="sales">
	...
	{{ Form::model( $sale_payment ,['route' => ['sale_payments.update' , $sale_payment->id],  'name' => 'addsalePaymentForm' , 'method' => 'PATCH', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController'  ]) }}
