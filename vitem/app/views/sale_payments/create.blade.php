...
<div ng-app="sales">
	...
	{{ Form::model( new SalePayment ,['route' => 'sale_payments.store',  'name' => 'addsalePaymentForm' , 'method' => 'POST', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController'  ]) }}
