...
<!-- page start-->
              <div class="row" ng-app="expenses" >
                  <aside class="profile-nav col-lg-3">
                      <section class="panel">
                          ...
                          <ul class="nav nav-pills nav-stacked">
                              ...
                              <li><a href="{{ route('expenses.edit' , [ $expense->id ]) }}"> <i class="fa fa-edit"></i> Editar gasto</a></li>
                          </ul>
                  ...
                  <aside class="profile-info col-lg-9">
                      ...
                      <section class="panel" ng-controller="ExpensesController">
