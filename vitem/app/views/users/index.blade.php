...
<div class="panel">
    <div class="panel-body">
        ...
        <header class="panel-heading col-sm-12">
            ...
            <a href="{{ route('users.create') }}"><button type="button" class="pull-right btn btn-success ">Agregar usuario</button></a>
        </header>    
                      ...
                      <div class="panel-body">
                          <div class="media">
                              ...
                              <div class="media-body">
                                  ...
                                  <a href="@{{ user.url_show }}" class="col-sm-4" >
                            <button type="button" class=" btn btn-success"><i class="fa fa-eye"></i></button>
                        </a>
                        <a href="@{{ user.url_edit }}" class="col-sm-4" >
                            <button  type="button" class="col-sm-offset-1 btn btn-info "><i class="fa fa-refresh"></i></button>
                        </a>
                        <a data-toggle="modal" href="#myModalD@{{user.id}}" class="col-sm-4" >
