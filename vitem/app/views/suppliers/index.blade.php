...
<div class="adv-table" ng-controller="SuppliersController">
<div class="panel">
    <div class="panel-body">
        <div ng-view></div>
        <header class="panel-heading col-sm-12">
            <h1 class="col-sm-3">Proveedores</h1>
            <a href="{{ route('suppliers.create') }}"><button type="button" class="pull-right btn btn-success ">Agregar proveedor</button></a>
        </header>
                      ...
                      <div class="panel-body">
                          <div class="media">
                              ...
                              <div class="media-body">
                                  ...
                                  <a href="@{{ supplier.url_show }}" class="col-sm-4" >
                            <button type="button" class=" btn btn-success"><i class="fa fa-eye"></i></button>
                        </a>
                        <a href="@{{ supplier.url_edit }}" class="col-sm-4" >
                            <button  type="button" class="col-sm-offset-1 btn btn-info "><i class="fa fa-refresh"></i></button>
                        </a>
                        <a data-toggle="modal" href="#myModalD@{{supplier.id}}" class="col-sm-4" >
                            <button type="button" class="col-sm-offset-1 btn btn-danger"><i class="fa fa-trash-o"></i></button>    
                        </a>
                              <div class="modal fade" id="myModalD@{{supplier.id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
