...
<div class="panel">
  ...
  <div class="panel-body" ng-app="products">
    {{ Form::model( $product->toArray() , ['route' => ['products.update', $product->id] , 'method' => 'PATCH' , 'name' => 'addProductForm' , 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController'  ]) }}
