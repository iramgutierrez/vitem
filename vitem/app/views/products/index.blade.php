...
<div ng-app="products" >
	...
	<div class="adv-table" ng-controller="ProductsController">
		<div class="panel">
			<div class="panel-body">
				<div ng-view></div>
				<header class="panel-heading col-sm-12">
				<h1 class="col-sm-3">Productos</h1>
					<a href="{{ route('products.create') }}"><button type="button" class="pull-right btn btn-success ">Agregar producto</button></a>
				</header>    
...
<tbody ng-if="viewGrid == 'list'" >
	<tr class="gradeX" ng-repeat="product in productsP | orderBy:sort:reverse">
		...
		<td>
			...
			<a data-toggle="modal" href="#myModal@{{product.id}}" >
					...
					<div class="media">
						...
						<div class="media-body col-sm-8">
							...
							<address>
								...
								&nbsp;@{{ product.address }}<br>                                      
								<span>&nbsp;<abbr title="Phone" ng-if="product.phone">P:</span> @{{ product.phone }}
							</address>
							@{{ product.employee.salary | currency }}<br>
							<div class="col-sm-6 pull-right">

								<a href="@{{ product.url_show }}" class="col-sm-4" >
									<button type="button" class=" btn btn-success"><i class="fa fa-eye"></i></button>
								</a>
								<a href="@{{ product.url_edit }}" class="col-sm-4" >
									<button  type="button" class="col-sm-offset-1 btn btn-info "><i class="fa fa-refresh"></i></button>
								</a>
								<a data-toggle="modal" href="#myModalD@{{product.id}}" class="col-sm-4" >
									<button type="button" class="col-sm-offset-1 btn btn-danger"><i class="fa fa-trash-o"></i></button>    
								</a>
								<div class="modal fade" id="myModalD@{{product.id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
