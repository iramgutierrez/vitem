...
<div ng-app="packages">
{{ Form::model( $pack ,['route' => ['packs.update', $pack->id],  'name' => 'addpackageForm' , 'method' => 'PATCH', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController'  ]) }}
<div class="panel">
...
<div class="panel">
  <div class="panel-body">                 
    ...
    <div class="form-group col-md-6 col-sm-12">
     ...
     'ng-init' => 'production_days =  '.$pack->production_days
     ]
     )
    }}
    </div>                       
