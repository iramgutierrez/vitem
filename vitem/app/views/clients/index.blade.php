...
@section('content')
<div   ng-app="clients" >
<div class="adv-table" ng-controller="ClientsController">
<div class="panel">
    <div class="panel-body">
        <div ng-view></div>
        <header class="panel-heading col-sm-12">
            <h1 class="col-sm-3">Clientes</h1>
            <a href="{{ route('clients.create') }}"><button type="button" class="pull-right btn btn-success ">Agregar cliente</button></a>
        </header>
                      ...
                      <div class="panel-body">
                          <div class="media">
                              ...
                              <div class="media-body">
                                  ...
                                  <a href="@{{ client.url_show }}" class="col-sm-4" >
                            <button type="button" class=" btn btn-success"><i class="fa fa-eye"></i></button>
                        </a>
                        <a href="@{{ client.url_edit }}" class="col-sm-4" >
                            <button  type="button" class="col-sm-offset-1 btn btn-info "><i class="fa fa-refresh"></i></button>
                        </a>
                        <a data-toggle="modal" href="#myModalD@{{client.id}}" class="col-sm-4" >
