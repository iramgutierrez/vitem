 ...
 */
	Router::connect('/registro',			    array('controller' => 'forms', 'action' => 'intro_form'));
    ...
    Router::connect('/eventos-deshabilitados',  array('controller' => 'disabled_events', 'action' => 'index'));
    Router::connect('/habilitar-evento/:id',    array('controller' => 'disabled_events', 'action' => 'enable_event'), array('id'=>'[0-9]+'));
    ...
    Router::connect('/listar-origins',      array('controller' => 'origins', 'action' => 'index'));
    Router::connect('/agregar-origin',      array('controller' => 'origins', 'action' => 'add'));
