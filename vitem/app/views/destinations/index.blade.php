...
<div class="adv-table" ng-controller="DestinationsController">
<div class="panel">
    <div class="panel-body">
        <div ng-view></div>
        <header class="panel-heading col-sm-12">
            <h1 class="col-sm-3">Destinos</h1>
            <a href="{{ route('destinations.create') }}"><button type="button" class="pull-right btn btn-success ">Agregar destino</button></a>
        </header>
                      ...
                      <div class="panel-body">
                          <div class="media">
                              ...
                              <div class="media-body">
                                  ...
                                  <a href="@{{ destination.url_show }}" class="col-sm-4" >
                            <button type="button" class=" btn btn-success"><i class="fa fa-eye"></i></button>
                        </a>
                        <a href="@{{ destination.url_edit }}" class="col-sm-4" >
                            <button  type="button" class="col-sm-offset-1 btn btn-info "><i class="fa fa-refresh"></i></button>
                        </a>
                        <a data-toggle="modal" href="#myModalD@{{destination.id}}" class="col-sm-4" >
                            <button type="button" class="col-sm-offset-1 btn btn-danger"><i class="fa fa-trash-o"></i></button>    
                        </a>
                              <div class="modal fade" id="myModalD@{{destination.id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
