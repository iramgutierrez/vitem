		...
		<aside class="profile-nav col-lg-3">
			<section class="panel">
				...
				<ul class="nav nav-pills nav-stacked" ng-init = "tab = 'venta' ">
					...
					<li><a ng-click="tab = 'abonos'" href="" > <i class="fa fa-edit"></i> Abonos</a></li>		
					@endif					
					<li><a ng-click="tab = 'comisiones'" href="" > <i class="fa fa-edit"></i> Comisiones</a></li>				
					<li><a ng-click="tab = 'entregas'" href="" > <i class="fa fa-edit"></i> Entregas</a></li>
		...
		<aside class="profile-info col-lg-9" ng-if="tab == 'venta' ">
	                      ...
	                      <section class="panel" >
	                      	...
	                      	<div class="panel-body bio-graph-info">
	                      		<div class="row">
	                      			<div class="col-sm-6">
	                      				<span class="col-sm-6">Vendedor </span><p class="col-sm-6"> {{ HTML::link( route('users.show', $sale->employee->id), $sale->employee->user->name ) }}</p>
	                      			</div>
	                      			<div class="col-sm-6">
	                      			...
	                      			<div class="col-sm-6">
	                      				<span class="col-sm-6">Forma de pago</span><p class="col-sm-6"> {{ $sale->pay_type }}</p>
	                      			</div>
	                      			<div class="col-sm-6">
		                      ...
		                      <section class="panel" >
		                      	...
		                      	<div class="panel-body">	
		                      		...
		                      		@if(count($sale->sale_payments))
		                      			...
		                      			<tr>
		                      				<td>{{ '<?php echo $sale_payment->quantity; ?>' | currency }}</td>
	                  ...
	                  <aside class="profile-info col-lg-9" ng-if="tab == 'comisiones' ">

	                      
		                      <section class="panel" >
		                      	<div class="panel-heading">
		                      		<h3>Comisiones. </h3>
		                      		<a href="{{ route('commissions.create.sale_id' , [ $sale->id ] ) }}" ><button type="button" class="pull-right btn btn-success "> Agregar comisión</button></a><br>
		                      	</div>
		                      	<div class="panel-body">	
		                      		<table class="table table-bordered table-striped table-condensed">
