						...
						<div class="media-body col-sm-12">
							<div class="col-sm-12">
								<ul>
									...
									<li class="col-sm-6">Vendedor : @{{sale.employee.user.name }}</li>
									<li class="col-sm-6">Cliente : @{{sale.client.name }}</li>
							...
							<div class="col-sm-6 pull-right">
								...
								<a href="@{{ sale.url_show }}" class="col-sm-4" >
									<button type="button" class=" btn btn-success"><i class="fa fa-eye"></i></button>
								</a>
								<a href="@{{ sale.url_edit }}" class="col-sm-4" >
									<button  type="button" class="col-sm-offset-1 btn btn-info "><i class="fa fa-refresh"></i></button>
								</a>
								<a data-toggle="modal" href="#myModalD@{{sale.id}}" class="col-sm-4" >
									<button type="button" class="col-sm-offset-1 btn btn-danger"><i class="fa fa-trash-o"></i></button>    
								</a>
								<div class="modal fade" id="myModalD@{{sale.id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
