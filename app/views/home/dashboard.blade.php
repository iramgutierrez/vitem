...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('library/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css') }}" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" href="{{ asset('library/css/owl.carousel.css') }}" type="text/css">
