...
<div class="panel">
    ...
    <div class="panel-body">
    	...
    	{{ Form::model( new Role ,['route' => 'roles.store',  'name' => 'addRoleForm' , 'method' => 'POST', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController'  ]) }}

        
        <header class="panel-heading col-sm-12">
        
            <h1 class="col-sm-3">Agregar rol</h1>
            ...
            {{
                ...
                Field::hidden(
                    ...
                    [
                        ...
                        'ng-init' => 'current_level = '.Input::old('level_id')
                    ]
                )
            }}
