<aside class="profile-info col-lg-9" ng-show="$root.auth_permissions.read.sale && tab == 'ventas' ">
<section class="panel" >
	<div >
		<div class="adv-table">
			<div class="panel">
				<div class="panel-body">
					...
					<header class="panel-heading col-sm-12">
						<h1 class="col-sm-12">Ventas del producto</h1>
					</header>
					...
					<table  class="display table table-bordered table-striped col-sm-12" id="dynamic-table" >
						...
						<tr class="gradeX" ng-repeat="sale in salesP | orderBy:sort:reverse">
							<td>@{{ sale.id }}</td>
							<td ng-if="$root.auth_permissions.read.client"><a href="@{{ sale.client.url_show }}">@{{ sale.client.name }}</a></td>
							<td ng-if="$root.auth_permissions.read.user"><a href="@{{ sale.employee.user.url_show }}">@{{ sale.employee.user.name }}</a></td>
