	...
	@if(isset($product) && !Input::old('ColorProduct'))
	...
	<table class="table stripped" >
		...
		<tr ng-show="notColor">
			...
			<td>
				...
				<input type="hidden" name="ColorProduct[@{{ notColor.id }}][quantity]" value="@{{ calculateMax() }}" />
			</td>
		</tr>
		<tr ng-repeat="(k ,color) in colors | orderBy : 'name' ">
			...
			<td>
				<button type="button" class="col-sm-6 col-sm-offset-1 btn btn-info " ng-click="updateColor(color)"><i class="fa fa-refresh"></i></button>
