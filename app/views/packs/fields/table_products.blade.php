...
" >
  ...
  <table class="table table-bordered table-striped table-condensed" ng-if="$root.productsSelected.length">
  		    ...
  		    <td>
          		...
          		<div id="spinner1 col-sm-2">
                    ...
                    <div class="input-group input-small">
                        ...
                        <input type="text" class="spinner-input form-control" maxlength="3" ng-model="product.quantity" name="PackProduct[@{{ product.id }}][quantity]" >
