...
<div ng-app="packages">
{{ Form::model( new Pack ,['route' => 'packs.store',  'name' => 'addpackageForm' , 'method' => 'POST', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController' , 'ng-init' => '$root.generateAuthPermissions('.\Auth::user()->role_id.')'   ]) }}
<div class="panel">
