...
@if(Input::old('ProductOrder'))
  @foreach(Input::old('ProductOrder') as $k => $p)
            productsOld.push({
              product_id : '{{ $k }}',
              quantity : '{{ $p['quantity'] }}',
              status : '{{ $p['status'] }}'
    ...
    <table class="table table-bordered table-striped table-condensed" >
        ...
        <tr ng-repeat="(k , product) in $root.productsSelected">
            ...
            <td>
                ...
                <select name="ProductOrder[@{{ product.id }}][status]" class="form-control" >
            ...
            <td>
                ...
                <div id="spinner1 col-sm-2">
                    ...
                    <div class="input-group input-small">
                        ...
                        <input type="text" class="spinner-input form-control" maxlength="3" ng-model="product.quantity" ng-init="product.quantity = quantityInit(product)" name="ProductOrder[@{{ product.id }}][quantity]" >
