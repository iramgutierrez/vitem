...
<div class="panel">
                          ...
                          <div class="panel-body" ng-app="suppliers">
                        		{{ Form::model( new Supplier ,['route' => 'suppliers.store',  'name' => 'addsupplierForm' , 'method' => 'POST', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController'  ]) }}
