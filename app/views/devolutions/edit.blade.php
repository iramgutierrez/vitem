...
@section('content')
    ...
    <div ng-app="devolutions">
        ...
        {{ Form::model( $devolution ,['route' => ['devolutions.update' , $devolution->id],  'name' => 'adddevolutionForm' , 'method' => 'PATCH', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController' , 'ng-init' => '$root.generateAuthPermissions('.Auth::user()->role_id.')'  ]) }}
