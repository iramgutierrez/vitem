...
<div class="panel">
                          ...
                          <div class="panel-body" ng-app="destinations">
                        		{{ Form::model( new Destination ,['route' => 'destinations.store',  'name' => 'adddestinationForm' , 'method' => 'POST', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController'  , 'ng-init' => '$root.generateAuthPermissions('.Auth::user()->role_id.')']) }}
