  ...
  <table class="table table-bordered table-striped table-condensed" >
    ...
    <thead>
      ...
      <tbody ng-repeat="(k , product) in $root.productsSelected track by k">
  		    ...
  		    <td class="col-sm-1">
          		...
          		<div id="spinner1 col-sm-2">
                    ...
                    <div class="input-group input-small">
                        ...
                        <input ng-if="!product.pack_id && !product.isPack" type="text" class="spinner-input form-control" maxlength="3" ng-model="product.quantity" name="ProductSale[@{{ k }}][quantity]" ng-init="product.quantity = quantityInit(product)">
        ...
        <tr ng-if="product.showSegments && !product.segments.length">
          <td colspan="10" class="text-right">Este producto no tiene criterios de segmentación asignados</td>
          <td></td>
          <td></td>
          <td></td>
        </tr>
        ...
        <tr  ng-show="product.showSegments && product.segments.length" ng-repeat="(c , segment)  in product.segments">
          ...
          <td>
              <input type="number" ng-if="!product.pack_id && !product.isPack" class="form-control" ng-model="product.assignedSegments[segment.pivot.id]" name="SegmentProductSale[@{{ k }}_@{{c}}][quantity]" ng-change="getProductsWithoutSegments(product)" />
