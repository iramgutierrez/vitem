                                  ...
                                  <div class="modal-dialog modal-lg">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
											  ...
											  {{ Form::model( new Client ,['route' => 'clients.store',  'name' => 'addclientForm' , 'id' => 'addclientForm' , 'method' => 'POST', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'AddClientController' , 'ng-init' => 'initJQuery("'.route('clients.image_ajax').'"); ' ]) }}
											  ...
											  <div class="form-group col-md-6 col-sm-12">
												  ...
												  <button type="button"  id="imageClient" >Subir imagen</button>
												  <div class="image" ></div>
												  {{ Field::hidden(
                                                         'image_profile',
                                                         null,
                                                         [
                                                             'class' => 'col-md-12 imageClientInput' ,
                                                         ]
                                                         )
                                                    }}
											  </div>
