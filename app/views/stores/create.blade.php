...
@section('content')
    ...
    <div ng-app="stores">
        ...
        {{ Form::model( new Store ,['route' => 'stores.store',  'name' => 'addstoreForm' , 'method' => 'POST', 'class' => 'form-inline' ,'role' => 'form', 'novalidate' , 'enctype' =>  'multipart/form-data' , 'ng-controller' => 'FormController'  , 'ng-init' => '$root.generateAuthPermissions('.Auth::user()->role_id.')']) }}
